...
import { Grid, Stack, Typography, Paper, Card, CardMedia, Button } from '@mui/material';
        ...
        <>
            <Grid container alignItems='center' justifyContent='center' direction='column' sx={{ mt: '100px' }}>
                <Grid item xs={12} md={12}>
                    <Stack spacing={6} alignItems='center' direction='column' justifyContent='center' sx={{ minHeight: '80vh' }}>
                        <Typography variant='h4' color='#14919B'>PROJECTS</Typography>                        
                    <Grid container spacing={2} direction='row' alignItems='flex-start' sx={{ maxWidth: '90vh' }}>
